...
function displayMessage(message) {
  ...
  $guessingResult.querySelector('h1').innerHTML = message;
}
...
function makeAnswerCircle(guess) {
  ...
  showCircle(guess, CIRCLE_NAME, $answerCircleArea).then((div) => { // Promise -> then
    div.id = 'answerCircle'; // css 참고
